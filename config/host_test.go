...
func TestParseHostPort(t *testing.T) {
	cases := []struct {
		...
		{"bare ipv6 zone with plus", "fe80::1%eth0+ap", 0, "fe80::1%eth0+ap", 0, false},
		{"zone with swallowed port", "fe80::1%eth0:22", 0, "", 0, true},
		{"zone with space", "fe80::1%eth 0", 0, "", 0, true},
		{"zone with slash", "fe80::1%eth/0", 0, "", 0, true},
		{"zone with percent", "fe80::1%%eth0", 0, "", 0, true},
		{"zone dot", "fe80::1%.", 0, "", 0, true},
		{"zone dotdot", "fe80::1%..", 0, "", 0, true},
		{"empty zone", "fe80::1%", 0, "", 0, true},
		{"bracketed ipv6 zone swallowed port", "[fe80::1%eth0:22]:22", 0, "", 0, true},
		{"bracketed ipv6 bad zone", "[fe80::1%bad zone!]:22", 0, "", 0, true},
		{"bracketed empty", "[]", 0, "", 0, true},
		{"bracketed empty with port", "[]:22", 0, "", 0, true},
		{"bracketed hostname scp style", "[web01]:2222", 0, "web01", 2222, false},
		{"empty host with port", ":22", 0, "", 0, true},
